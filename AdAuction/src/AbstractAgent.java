...
public abstract class AbstractAgent extends Agent {
    ...
    {
    	for(QueryReport qr : queryReports)
    	{
    		for (Query q : querySpace)
    		{
    			System.out.println(qr.getClicks(q));
    			System.out.println(qr.getCost(q));
    			System.out.println(qr.getCPC(q));
    			System.out.println(qr.getImpressions(q));
    			System.out.println(qr.getPosition(q));
    			System.out.println(qr.getAd(q));
    		}
    	}
